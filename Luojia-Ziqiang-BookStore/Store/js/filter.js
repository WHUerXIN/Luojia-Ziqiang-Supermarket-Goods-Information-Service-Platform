...
function select(n) {
	...
	for (var i = 0; i < dds.length; i++) {
		dds[i].onclick = function () {
            ...
            dd.appendChild(span);
            //document.getElementById(parent.innerText.substring(0, 2)).value = this.innerText;
            document.getElementById('ContentPlaceHolder1_' + parent.innerText.substring(0, 2)).value = this.innerText;
		};
	}
}